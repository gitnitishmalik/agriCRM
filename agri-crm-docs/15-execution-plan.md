...
**The rule that governs this document:** a phase does not end because its weeks ran out. It ends when its exit gate passes. If week 9 arrives and the registry holds 4,000 FPOs instead of 20,000, Phase 1 is not finished — and starting Phase 2 on top of an unproven ingestion pipeline is how you get to week 30 with a system nobody trusts.

---

## Track P — Parallel workstreams (start week 1, never stop)

🔴 These four are not a phase. They start on day one **regardless of what engineering is doing**, because each has an external dependency measured in weeks and each blocks a later phase. Every one of them is routinely deferred into its "own" phase, and every one of them then becomes the reason that phase slips.

| # | Workstream | Owner | Lead time | Blocks |
|---|---|---|---|---|
| **P1** | Data protection lawyer | You | 3–6 weeks | Phase 2 exit, Phase 4 launch |
| **P2** | Theta legacy data audit | Data ops + you | 4–8 weeks | Phase 2 import |
| **P3** | Meta business verification | You | 1–3 weeks, can stall | Phase 4 entirely |
...
🔴 Have a BSP (AiSensy, Gupshup, Interakt) identified as contingency. If verification stalls, a BSP is a 2-week integration instead of a 6-week one, and you migrate to direct later.

### P4 · BD partnership outreach

List your first 20 target FPO/mill partnerships and start the conversations in week 1. The BD motion and the data acquisition are the same activity. Every week of outreach that starts now is a week of consented farmer data that exists when Phase 2 is ready to import it.

Also in week 1: **pick your first two states.** Almost certainly UP and Maharashtra. Depth in two beats breadth in twenty.
...
| **Start early** | 🔴 SES domain warming takes 3–4 weeks — **begin it in this phase**, not Phase 4 |
...
| Rollout | 🔴 **Pilot with 5 agents for 3 weeks**, design *with* two of them, then roll out |
...
- [ ] Pilot agents choose to keep using it after week 3
